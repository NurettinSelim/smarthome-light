...
#define DATABASE_URL "<project-name>-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "demo@demo.com"
#define USER_PASSWORD "demo123"


#define LED_PIN 22

#define LOCATION "/light/OnOff/on"
...
void setup()
{
  ...
  bool lightVal;
  Firebase.RTDB.getBool(&fbdo, F(LOCATION), &lightVal);
  digitalWrite(LED_PIN, lightVal);
  ...
  if (!Firebase.RTDB.beginStream(&fbdo, LOCATION))
  ...
  */
  ...
  if (Firebase.ready())
  {
    ...
    if (fbdo.streamAvailable())
    {
      ...
      digitalWrite(LED_PIN, fbdo.to<bool>());
    }
  }
}